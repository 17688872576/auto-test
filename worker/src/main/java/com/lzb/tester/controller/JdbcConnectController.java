...
public class JdbcConnectController extends ManageController<JdbcConnectInfo> {

    @Autowired
    public JdbcConnectController(JdbcConnectInfoService<JdbcConnectInfo> service) {
        super.service = service;
    }

    @PostMapping("/save")
    @ResponseBody
    public BaseResult save(@RequestBody JdbcConnectInfo entity){
    ...
    @GetMapping("/findOne")
    @ResponseBody
    public BaseResult<JdbcConnectInfo> findOneById(@RequestParam("id") String id){
    ...
    @PutMapping("/update")
    @ResponseBody
    public BaseResult update(@RequestBody JdbcConnectInfo entity){
